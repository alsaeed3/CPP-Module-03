...
/*   Updated: 2024/04/23 19:16:14 by alsaeed          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*********************************************************************************************/
ClapTrap::ClapTrap( void ) : _name( "DEFAULT" ), _hp( _defHp ), _ep( _defEp ), _ad( _defAd ) {
...
ClapTrap::ClapTrap( std::string name ) : _name( name ), _hp( _defHp ), _ep( _defEp ), _ad( _defAd ) {
